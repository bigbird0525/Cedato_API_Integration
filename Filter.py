...
class Filter(object):
    ...
    def slice_n_dice(self, data):
        ...
        df_filtered = df[(df.adRequest.astype(int)>5000)].sort_values(by=['RPR'], ascending=False).reset_index(drop=True)
        ...
        df_filtered['supply_type'] = df_filtered['supply_type'].astype(str)
